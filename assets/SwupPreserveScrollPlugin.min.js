(function e(t, r) {
  if (typeof exports === 'object' && typeof module === 'object')
    ...
    exports['SwupPreserveScrollPlugin'] = r();
  else t['SwupPreserveScrollPlugin'] = r();
})(window, function () {
  return (function (e) {
    var t = {};
    function r(n) {
    ...
    function (e, t, r) {
      ...
      var p = (function (e) {
        ...
        function t() {
          ...
          r.name = 'PreserveScrollPlugin';
          r.getURL = function () {
            r.previousPage = (0, a.getCurrentUrl)();
            return;
          };
          r.getScrolls = function () {
            var e = document.querySelectorAll(r.options.selector);
            if (!(e.length > 0)) {
              if (r.options.quiet !== true)
                console.warn(
                  r.previousPage +
                    ": there were no elements matching the '" +
                    r.options.selector +
                    "' selector.",
                );
              r.previousPage = null;
          ...
          r.applyScrolls = function () {
            ...
            e.forEach(function (e) {
              ...
              var t = e.id;
              if (r.swupPreserveScroll[t]) {
                e.scrollTop = r.swupPreserveScroll[t].top;
                e.scrollLeft = r.swupPreserveScroll[t].left;
              }
            });
            return;
          };
          var o = { selector: '.swup-preserve-scroll', quiet: false };
          r.options = n({}, o, e);
          return r;
        }
        o(t, [
    ...
    function (e, t, r) {
      ...
      var _ = (t.createHistoryRecord = i.default);
      var S = (t.getDataFromHtml = l.default);
      var P = (t.fetch = c.default);
      var O = (t.transitionEnd = p.default);
      var j = (t.getCurrentUrl = v.default);
      var k = (t.markSwupElements = h.default);
      var M = (t.Link = m.default);
    },
    function (e, t, r) {
      'use strict';
      Object.defineProperty(t, '__esModule', { value: true });
    ...
    function (e, t, r) {
      ...
      var u = function e(t, r) {
        ...
        var a = function e(t) {
          if (u.querySelector(r[t]) == null) {
            ...
            (0, o.queryAll)(r[t]).forEach(function (e, n) {
              (0, o.queryAll)(r[t], u)[n].setAttribute('data-swup', i.length);
        ...
        for (var l = 0; l < r.length; l++) {
          var f = a(l);
          if ((typeof f === 'undefined' ? 'undefined' : n(f)) === 'object')
            return f.v;
        }
        var c = {
          title: u.querySelector('title').innerText,
          pageClass: u.querySelector('body').className,
          originalContent: t,
          blocks: i,
        };
        u.innerHTML = '';
    ...
    function (e, t, r) {
      ...
      var o = function e(t) {
        ...
        i.open(u.method, u.url, true);
        Object.keys(u.headers).forEach(function (e) {
          i.setRequestHeader(e, u.headers[e]);
        });
        i.send(u.data);
        return i;
      };
    ...
    function (e, t, r) {
      ...
      var o = function e(t, r) {
        var o = 0;
        var u = function e(u) {
          if (t.querySelector(r[u]) == null) {
            console.warn('Element ' + r[u] + ' is not in current page.');
          } else {
            (0, n.queryAll)(r[u]).forEach(function (e, i) {
              (0, n.queryAll)(r[u], t)[i].setAttribute('data-swup', o);
              o++;
            });
          }
        };
